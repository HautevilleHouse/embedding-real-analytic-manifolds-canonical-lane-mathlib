import HautevilleHouse.EmbeddingRealAnalyticManifoldsCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "manifold-constrained theorem certificate internalized through embedding results and analytic manifold substrate",
